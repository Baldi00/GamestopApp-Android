...
public class GamePreview {
    ...
    */
    public static Games searchGame(String searchedGameName, MainActivity main) throws UnsupportedEncodingException, IOException {
        ...
        for(Element game : gamesList){
            ...
            Game previewGame = new Game(gameUrl, main);
